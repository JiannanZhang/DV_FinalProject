...
sydneyr2 <-sydney_rain%>% group_by(MONTH) %>% summarise( average = round(mean(RAINFALL_AMOUNT_MM),2))
...
darwinr2 <- Darwin_rain%>% group_by(MONTH) %>% summarise( average = round(mean(RAINFALL_AMOUNT_MM),2))
...
adelaider2 <- adelaide_rain%>% group_by(MONTH) %>% summarise( average = round(mean(RAINFALL_AMOUNT_MM),2))
...
brisbaner2 <- brisbane_rain%>% group_by(MONTH) %>% summarise( average = round(mean(RAINFALL_AMOUNT_MM),2))
...
cairnsr2 <- cairns_rain%>% group_by(MONTH) %>% summarise( average = round(mean(RAINFALL_AMOUNT_MM),2))
...
canberrar2 <- canberra_rain%>% group_by(MONTH) %>% summarise( average = round(mean(RAINFALL_AMOUNT_MM),2))
...
hobartr2 <- hobart_rain%>% group_by(MONTH) %>% summarise( average = round(mean(RAINFALL_AMOUNT_MM),2))
...
melbourner2 <- melbourne_rain%>% group_by(MONTH) %>% summarise( average = round(mean(RAINFALL_AMOUNT_MM),2))
...
perthr2 <-perth_rain%>% group_by(MONTH) %>% summarise( average = round(mean(RAINFALL_AMOUNT_MM),2))
...
townsviller2 <- townsville_rain%>% group_by(MONTH) %>% summarise( average = round(mean(RAINFALL_AMOUNT_MM),2))
