...
Lastly, we blended the rainfall and temperature data on Tableau partitioning by Year and Month. As you look at the visual, 2005 is used as the based year and every month is then the basis for the following year's month. Rainfall fluctuates a lot more heavily than temperature. 
